                    ...
                    <div class="card-body" id="out_print">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <h2 class="text-center"><b>Goods Receipt Note<</b></h2>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-6">
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered" id="item-list">
                                    ...
                                    <tbody>
                                        ...
                                        $subtotal = 0;
                                        @endphp
                                        @foreach($grnItems as $grn_items)
                                        <tr class="po-item" data-id="">
                                            @php
                                            $subtotal += ($grnItems->order_quantity) * ($grnItems->order_unitprice)
                                            @endphp
                                            <td class="align-middle p-0 text-center">{{$index + 1}}</td>
                                            <td class="align-middle p-1 text-center">{{$item->product_received}}</td>
                                            <td class="align-middle p-1">{{$item->description}}</td>
                                            <td class="align-middle p-1 item-description"></td>
                                            <td class="align-middle p-1 text-right">{{$item->product_uom}}</td>
                                            <td class="align-middle p-1 text-right total-price">{{$item->qty}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr class="bg-lightblue">
                                            <th class="p-1 text-right" colspan="5">Total Quantity:</th>
