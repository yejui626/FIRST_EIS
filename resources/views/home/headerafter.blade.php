      <header class="header_section">
         <div class="container">
            <nav class="navbar navbar-expand-lg custom_nav-container ">
               <a class="navbar-brand" href="{{url('/')}}"><img width="150" src="/images/favicon.png" alt="#" /></a>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="{{ route('newAddress') }}">My Address</a>
                     </li>
                     <li class="nav-item">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                           <li><a class="dropdown-item" onclick="document.getElementById('formLogOut').submit();">{{ __('Log out') }}</a></li>
