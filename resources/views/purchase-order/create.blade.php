                        ...
                        <div class="row">
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm rounded-0" id="supplier_name"
                                 value="{{$purchaserequest->supplier->supplier_name}}" readonly>
                            </div>
                                <input type="hidden" class="form-control form-control-sm rounded-0" id="supplier_id"
                                    name="supplier_id" value="{{$purchaserequest->supplier_id}}" hidden>
                                    <input type="hidden" class="form-control form-control-sm rounded-0" id="requestor"
                                    name="requestor" value="{{$purchaserequest->requestor}}" hidden>
                                    <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm rounded-0" id="po_prno"
                                    name="po_prno" value="{{$purchaserequest->id}}" readonly>
                            </div>
                        </div>
                        
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table table-bordered" id="item-list">
                                    <colgroup>
                                        <col width="5%">
                                        <col width="5%">
                                        <col width="5%">
                                    ...
                                    $subtotal = 0;
                                    @endphp
                                    @foreach($PurchaseRequest_Items as $orderItem)
                                        ...
                                        <tr class="po-item" data-id="">
                                            ...
                                            <td class="align-middle p-0 text-center">
                                                <input type="number" class="text-center w-100 border-0"
                                                    step="any" name="order_quantity[]" value="{{$orderItem->product_quantity}}" required/>
                                            </td>
                                            <td class="align-middle p-1">
                                                <input type="text" class="text-center w-100 border-0"
                                                    step="any" name="order_unit[]" value="{{$orderItem->uom}}" required/>
                                            ...
                                            <td class="align-middle p-1">
                                                <input type="text" class="text-center w-100 border-0"
                                                    ...
                                                    value="{{$orderItem->product_id}}" name="order_item_id[]" required readonly/>
                                            </td>
                                            ...
                                            <td class="align-middle p-1">
                                                <input type="number" step="any"
                                                    class="text-right w-100 border-0" name="order_unitprice[]" value="{{$orderItem->product_unitprice}}" required />
                                            </td>
                                            ...
                                            <tr>
                                                <th class="p-1 text-right" colspan="6">Discount (%)
                                                    <input type="number" step="any" name="discount_percentage"
                                                        class="border-light text-right" value = "{{number_format($purchaserequest->discount_percentage ?? 0, 2)}}">
                                                </th>
                                                <th class="p-1"><input type="text" class="w-100 border-0 text-right"
                                                        readonly  name="discount_amount" ></th>
                                            </tr>
                                            <tr>
                                                <th class="p-1 text-right" colspan="6">Tax Inclusive (%)
                                                    <input type="number" step="any" name="tax_percentage"
                                                        class="border-light text-right" value = "{{number_format($purchaserequest->tax_percentage ?? 0, 2)}}">
                                                </th>
                                                <th class="p-1"><input type="text" class="w-100 border-0 text-right"
                                                         name="tax_amount"></th>
                                            </tr>
